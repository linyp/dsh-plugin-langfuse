...
/** Groups traces under one Langfuse session; carries the dsh session id. */
...
/** Trace-level input rendered in Langfuse's trace view. */
export const ATTR_LANGFUSE_TRACE_INPUT = 'langfuse.trace.input'
/** Trace-level output rendered in Langfuse's trace view. */
