...
export const ATTR_LANGFUSE_ENVIRONMENT = 'langfuse.environment'
export const ATTR_LANGFUSE_TRACE_METADATA_DSH_CWD = 'langfuse.trace.metadata.dsh_cwd'
export const ATTR_LANGFUSE_TRACE_METADATA_DSH_AGENT_PRESET = 'langfuse.trace.metadata.dsh_agent_preset'
export const ATTR_LANGFUSE_TRACE_METADATA_DSH_SUBAGENT_LABEL = 'langfuse.trace.metadata.dsh_subagent_label'
/**
...
export const ATTR_LANGFUSE_OBSERVATION_MODEL_PARAMETERS = 'langfuse.observation.model.parameters'
export const ATTR_LANGFUSE_OBSERVATION_METADATA = 'langfuse.observation.metadata'
...
export const ATTR_DSH_SESSION_CWD = 'dsh.session.cwd'
export const ATTR_DSH_REQUEST_CONTEXT_WINDOW = 'dsh.request.context_window'
export const ATTR_DSH_REQUEST_REASONING_EFFORT = 'dsh.request.reasoning_effort'
export const ATTR_DSH_REQUEST_HEADER_REASON = 'dsh.request.header_reason'
export const ATTR_DSH_LLM_RETRY_ID = 'dsh.llm.retry.id'
export const ATTR_DSH_LLM_RETRY_ATTEMPT = 'dsh.llm.retry.attempt'
export const ATTR_DSH_LLM_RETRY_PROVIDER = 'dsh.llm.retry.provider'
export const ATTR_DSH_LLM_RETRY_MODE = 'dsh.llm.retry.mode'
export const ATTR_DSH_LLM_RETRY_POLICY_KEY = 'dsh.llm.retry.policy_key'
export const ATTR_DSH_LLM_RETRY_DELAY_MS = 'dsh.llm.retry.delay_ms'
export const ATTR_DSH_LLM_RETRY_FAILURE_CODE = 'dsh.llm.retry.failure.code'
export const ATTR_DSH_LLM_RETRY_FAILURE_MESSAGE = 'dsh.llm.retry.failure.message'
export const ATTR_DSH_LLM_RETRY_FAILURE_STATUS = 'dsh.llm.retry.failure.status'
export const ATTR_DSH_APPROVAL_ID = 'dsh.approval.id'
export const ATTR_DSH_APPROVAL_OUTCOME = 'dsh.approval.outcome'
export const ATTR_DSH_APPROVAL_REASON = 'dsh.approval.reason'
/** Tool correlation on an approval span; deliberately not gen_ai.tool.* so receivers do not reclassify it as a tool call. */
export const ATTR_DSH_APPROVAL_TOOL_NAME = 'dsh.approval.tool.name'
export const ATTR_DSH_APPROVAL_TOOL_CALL_ID = 'dsh.approval.tool.call_id'
export const ATTR_DSH_TOOL_ERROR_NAME = 'dsh.tool.error.name'
export const ATTR_DSH_TOOL_ERROR_CODE = 'dsh.tool.error.code'
export const ATTR_DSH_TOOL_OUTCOME = 'dsh.tool.outcome'
export const ATTR_DSH_COMPACTION_INCOMPLETE = 'dsh.compaction.incomplete'
export const ATTR_DSH_INCOMPLETE_REASON = 'dsh.incomplete_reason'
